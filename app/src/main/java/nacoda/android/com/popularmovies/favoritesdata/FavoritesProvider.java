...
public class FavoritesProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
         ...
         */
        uriMatcher.addURI(FavoritesContract.AUTHORITY, FavoritesContract.BASE_PATH, FAVORITES);
        uriMatcher.addURI(FavoritesContract.AUTHORITY, FavoritesContract.BASE_PATH + "/#", FAVORITES_WITH_ID);
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            case FAVORITES_WITH_ID:
                ...
                tasksDeleted = db.delete(FavoritesContract.FavoritesEntry.TABLE_NAME, FavoritesContract.FavoritesEntry.COLUMN_MOVIE_ID + "=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
